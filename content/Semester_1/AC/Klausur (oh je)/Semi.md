...
>$$
>[H3O+] = \sqrt{\frac{K_{Ax}\cdot K_{Ax+1}\cdot c_{0x+1} + K_{Ax}K_W}{K_{Ax}+c_{0x+1}}}
>$$
...
# Iodometrie
Grundlegende Reaktion
$$
\ce{I2 +2e- <=> 2 I-}
$$
Wenn Reaktion mit Reduktionsmittel:
$$
\ce{S^2- + I2 <=> S + 2 I-}
$$
Bei der Reaktion mit einem Oxidationsmittel kehrt sich der Vorgang um
$$
\ce{2Cu^2+ + 4 I- <=> 2 CuI + I}
$$

Bei der Reduktion wird im Überschuss angesäuerte Kaliumiodid Lösung zum Reduzieren hinzugegeben. Das Iod wird dann mit Natriumthiosulfat titriert.

$$
\ce{I2 + 2S2O3^2- <=> 2 I- + S4O6^2-}
$$

### Indikator
Die in der Iodometrie verwendeten Lösungen enthalten stets etwas Kaliumiodid. Zusammen mit dem Iod lässt sich somit Iod in sehr geriingen  Konzentrationen mithilfe von Stärkelösungen nachweisen nachweisen.

# Manganometrie
Grundlegende Reaktion (in sauren Lösungen)
$$
\ce{MnO4^2- + 4 8+ +5e- <=> Mn^2+ + 4H2O }
$$
Permanganat ist selbst Indikator
(nach kurzer Zeit entfärbung da Umsetzung zu Braunstein)